...
export function DashboardSidebar({ className, ...props }: HTMLAttributes<HTMLElement>) {
    return (
        <aside className={cn('rounded-sm p-4 border', className)} {...props}>
            <h2 className="text-muted-foreground font-medium mb-14">Upcoming reminders</h2>
            <section className="flex flex-col">
                <div className="mx-auto mb-5">
                    <EmptyNotification />
                </div>
                <p className="text-center text-sm text-muted-foreground max-w-xs">You have no reminders. Upcoming reminders will show here </p>
            </section>
        </aside>
    )
}
...
function EmptyNotification() {
    return (
        <svg width="120" height="120" viewBox="0 0 182 170" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M57.0837 143.789C55.2288 147.002 54.7262 150.82 55.6863 154.403C56.6465 157.987 58.9909 161.042 62.2037 162.897C65.4165 164.752 69.2347 165.254 72.8181 164.294C76.4015 163.334 79.4568 160.99 81.3117 157.777L69.1977 150.783L57.0837 143.789Z" fill="#EDE8FC" stroke="#683DF5" strokeWidth="1.7485" mask="url(#path-3-inside-1_562_11090)" />
            {/* TODO: abstract these colors inside tailwind config */}
            <circle cx="53.9424" cy="20.6543" r="5.24551" fill="#EDE8FC" stroke="#683DF5" strokeWidth="0.874251" />
            <circle cx="145.739" cy="91.4688" r="5.24551" fill="#EDE8FC" stroke="#683DF5" strokeWidth="0.874251" />
            <circle cx="16.3495" cy="77.4805" r="5.24551" fill="#EDE8FC" stroke="#683DF5" strokeWidth="0.874251" />
        </svg>
