...
import { ChevronUp, LogOut, Palette, User as UserIcon } from 'lucide-react';
...
export function ProfileDropdown({ profile, user, expanded }: { profile: Profile, user: User, expanded: boolean }) {
