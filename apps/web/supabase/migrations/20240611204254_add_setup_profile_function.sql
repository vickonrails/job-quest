...
CREATE OR REPLACE FUNCTION public.setup_profile(user_id uuid, profile profile_type, work_experience work_experience_type[], projects project_type[], education education_type[])
 RETURNS void
 LANGUAGE plpgsql
AS $function$
begin
