...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black opacity-30 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
export function Sheet({ open, children, title, ...rest }: SheetProps) {
  return (
    <SheetRoot open={open} {...rest}>
      <SheetContent className="overflow-auto max-w-xl">
